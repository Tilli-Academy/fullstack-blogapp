...
function SidebarContent({ isLoggedIn, isAdmin, username, onLinkClick }) {
  return (
    <>
      <nav className="space-y-1">
        <SidebarLink href="/" icon={<HomeIcon />} label="Home" onClick={onLinkClick} />
        <SidebarLink href="/people" icon={<PeopleIcon />} label="People" onClick={onLinkClick} />
        {isLoggedIn && (
          <>
            <SidebarLink
...
export default function Sidebar({ isLoggedIn, isAdmin, username }) {
    ...
    <>
      ...
      >
        <div className="w-56 flex-shrink-0">
          <SidebarContent isLoggedIn={isLoggedIn} isAdmin={isAdmin} username={username} />
        </div>
      </aside>
